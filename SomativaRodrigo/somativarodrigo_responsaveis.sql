...
CREATE TABLE `responsaveis` (
  ...
  CONSTRAINT `responsaveis_ibfk_1` FOREIGN KEY (`responsavelFK`) REFERENCES `usuarios` (`id`),
  CONSTRAINT `responsaveis_ibfk_2` FOREIGN KEY (`tarefaFK`) REFERENCES `tarefas` (`idTarefa`)
...
INSERT INTO `responsaveis` VALUES (1,1,1),(2,4,1),(3,5,2),(4,6,3),(5,2,4);
...
-- Dump completed on 2023-06-06  2:13:48
